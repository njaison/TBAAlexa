...
let speechOutput;
let reprompt;
let welcomeOutput = "Welcome to volunteer hours tracker!";
...
const handlers = {
    ...
    'AddHoursIntent': function () {
        ...
        let eventSlotRaw = this.event.request.intent.slots.event.value;
        console.log(eventSlotRaw);
        var eventSlot = resolveCanonical(this.event.request.intent.slots.event);
    ...
    'EmailHoursIntent': function () {
        ...
        //Your custom intent handling goes here
        speechOutput = "This is a place holder response for the intent named EmailHoursIntent. This intent has no slots. Anything else?";
        this.emit(":ask", speechOutput, speechOutput);
    },
